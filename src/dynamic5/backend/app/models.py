...
class Book(Model):
    ...
    authors = ArrayField(CharField(max_length=255, null=True, blank=True), null=True, blank=True)
    translators = ArrayField(CharField(max_length=255, null=True, blank=True), null=True, blank=True)
    ...
    score = CharField(max_length=255, blank=True, null=True)
